    ...
    <ServicesContainer id="services">
        ...
        <ServicesWrapper>
            <ServicesCard>
                ...
                <ServicesP>We help reduce expenses effectively and increase overall revenue</ServicesP>
            </ServicesCard>
            <ServicesCard>
                <ServicesIcon src={Icon2}/>
                <ServicesH2>Virtual Offices</ServicesH2>
                <ServicesP>You can access our platforms from anywhere in the world</ServicesP>
            </ServicesCard>
            <ServicesCard>
